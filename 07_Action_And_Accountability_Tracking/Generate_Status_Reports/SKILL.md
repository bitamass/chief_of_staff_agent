...
description: Perform generate status reports using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Generate Status Reports

## Purpose
Perform **generate status reports** as a distinct executive workflow—not as a generic summary.
