...
description: Perform priority conflict detection using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Priority Conflict Detection

## Purpose
Perform **priority conflict detection** as a distinct executive workflow—not as a generic summary.
