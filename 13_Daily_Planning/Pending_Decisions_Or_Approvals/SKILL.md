...
description: Perform pending decisions or approvals using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Pending Decisions Or Approvals

## Purpose
Perform **pending decisions or approvals** as a distinct executive workflow—not as a generic summary.
