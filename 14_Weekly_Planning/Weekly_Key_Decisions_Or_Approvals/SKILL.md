...
description: Perform weekly key decisions or approvals using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Weekly Key Decisions Or Approvals

## Purpose
Perform **weekly key decisions or approvals** as a distinct executive workflow—not as a generic summary.
