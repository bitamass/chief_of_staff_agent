...
description: Perform define weekly priorities using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Define Weekly Priorities

## Purpose
Perform **define weekly priorities** as a distinct executive workflow—not as a generic summary.
