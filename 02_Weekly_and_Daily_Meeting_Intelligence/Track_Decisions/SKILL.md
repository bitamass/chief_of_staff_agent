...
description: Perform track decisions using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Track Decisions

## Purpose
Perform **track decisions** as a distinct executive workflow—not as a generic summary.
