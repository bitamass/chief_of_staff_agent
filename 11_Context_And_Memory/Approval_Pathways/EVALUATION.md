# Evaluation — Approval Pathways

The result passes when:

- It answers the specific approval pathways question.
- Every material claim is traceable to dated evidence.
- The decision or approval queue has the required fields and accountable owners.
