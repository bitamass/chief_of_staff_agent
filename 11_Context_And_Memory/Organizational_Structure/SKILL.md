...
description: Perform organizational structure using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Organizational Structure

## Purpose
Perform **organizational structure** as a distinct executive workflow—not as a generic summary.
