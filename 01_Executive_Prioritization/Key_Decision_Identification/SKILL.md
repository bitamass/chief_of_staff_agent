...
description: Perform key decision identification using the named evidence, business rules, and executive output defined for this Chief of Staff skill.
---
# Key Decision Identification

## Purpose
Perform **key decision identification** as a distinct executive workflow—not as a generic summary.
